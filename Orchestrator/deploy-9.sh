...
kubectl create -f /home/user123/Applications/Mavericks_Kubernetes_Client/pattern-distributed/sp/wso2sp-worker-8-service-1.yaml
#kubectl create -f ../sp/wso2sp-worker-9-service.yaml
kubectl create -f /home/user123/Applications/Mavericks_Kubernetes_Client/pattern-distributed/sp/wso2sp-worker-10-service-1.yaml
...
kubectl create -f /home/user123/Applications/Mavericks_Kubernetes_Client/pattern-distributed/sp/wso2sp-worker-8-deployment.yaml
#kubectl create -f ../sp/wso2sp-worker-9-deployment.yaml
kubectl create -f /home/user123/Applications/Mavericks_Kubernetes_Client/pattern-distributed/sp/wso2sp-worker-10-deployment.yaml
...
kubectl expose deployment wso2sp-worker-8 --type=NodePort --name=wso2sp-worker-8-service-1
NODEPORT8=$(kubectl get -o jsonpath="{.spec.ports[0].nodePort}" services wso2sp-worker-8)
gcloud compute firewall-rules create rule-8 --allow=tcp:$NODEPORT8

kubectl expose deployment wso2sp-worker-10 --type=NodePort --name=wso2sp-worker-10-service-1
NODEPORT10=$(kubectl get -o jsonpath="{.spec.ports[0].nodePort}" services wso2sp-worker-10)
gcloud compute firewall-rules create rule-10 --allow=tcp:$NODEPORT10
