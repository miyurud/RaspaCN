...
public class ResourceManagerConstants {
    ...
    public static final String CREATE_PREVIOUS_MERRICS_TABLE =
            "CREATE TABLE IF NOT EXISTS previous_metrics_table" +
                     "(exec int, " +
                    "parallel varchar(20), " +
                    ...
                    "process_CPU double " +
        " );";
 /*   public static final String CREATE_PREVIOUS_LAYOUT_TABLE = "CREATE TABLE IF NOT EXISTS previousLayout" +
    ...
    public static final String CREATE_DATARATE_TABLE = "CREATE TABLE IF NOT EXISTS dataratetable" +
            " (iijtimestamp bigint(20) ,exec int(8)," +
            " parallel VARCHAR(20),m1 int(10), m2 double(10,6), m3 double(20,10)) ";
}
