...
public class RDBMSServiceImpl {
    ...
    private void createResourcePoolTable() {
        ...
        try {
            ...
            preparedStatement4 = connection.prepareStatement(ResourceManagerConstants.CREATE_PREVIOUS_MERRICS_TABLE);
            preparedStatement4.execute();
            /*preparedStatement5 = connection.prepareStatement(ResourceManagerConstants.CREATE_PREVIOUS_LAYOUT_TABLE);
            preparedStatement5.execute();*/
            preparedStatement6 = connection.prepareStatement(ResourceManagerConstants.CREATE_DATARATE_TABLE);
            ...
            close(preparedStatement4, "Execute query");
            //close(preparedStatement5, "Execute query");
            close(preparedStatement6, "Execute query");
